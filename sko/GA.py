    ...
    def run(self, max_iter=None):
        ...
        for i in range(self.max_iter):
            ...
            if last_best_index is None:
                last_best_index = generation_best_index
            if last_best is None:
                last_best = self.X[generation_best_index, :]
            self.generation_best_X.append(self.X[generation_best_index, :])
            if self.FitV[generation_best_index] > self.FitV[last_best_index]:
                # print(self.FitV[generation_best_index])
                last_best = self.X[generation_best_index, :]
                last_best_index = generation_best_index
